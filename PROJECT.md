...
### Phase 4: Core Galaga Features (2-3 weeks)
**Goal:** Add Galaga mechanics to deepen gameplay

- [ ] **Enemy Formations** - Proper Galaga layout (4 Boss + 8 Goei + 10 Zako)
- [ ] **Challenge Stages** - Every 4th stage: non-attacking bonus waves
- [ ] **Boss Tractor Beam** - Capture/rescue mechanic
- [ ] **Dual Fighter** - Power-up for rescued ship (double shots)

**Why Second:** Builds on state machine and level progression

---

### Phase 5: Polish & Release (1-2 weeks)
**Goal:** Optimize, test, and package for distribution

- [ ] **Performance Tuning** - Target 60 FPS, profile collision detection
- [ ] **Comprehensive Tests** - 70%+ coverage, integration tests
- [ ] **2-Player Mode** - Alternating turns (foundational)
- [ ] **Release Package** - Setup pip distribution, artifacts

**Why Last:** Only after core features are solid
...
| M5: Galaga Mechanics | Dec 8, 2025 | Boss, formations, challenge stages |
...
| Enemy Formations | ⏳ Planned | `src/entities/` | ⚠️ Needed | Galaga 40-enemy layout |
...
### Phase 4 (Galaga Features)
- ✅ Proper Galaga formations
- ✅ Challenge stages working
- ✅ Boss tractor beam functional
- ✅ Tests passing (20/20+)
